...
版管理機能の追加により、編集中のブックを「リリース」することで版として固定できるようになりました。 これにより、年度単位での教材管理や、版ごとの視聴履歴の管理、共有運用の明確化が可能となります。
...
| 対応                        | 長所               | 短所                                         |
| ------------------------- | ---------------- | ------------------------------------------ |
| リリースしない                   | なにもしなくていい        | <p>新規で共有できない<br><br>将来的にデータの整合性が保証されない</p> |
