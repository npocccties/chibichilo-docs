---
description: 本機能はzoom連携機能が設定されているLTI-MCだけが使える機能です．詳しくはシステム管理者にお問い合わせください．
---
...
{% hint style="info" %}
Zoomの動画をインポートするには，ZoomとLMSで同じメールアドレスを使用する必要があります．また，Zoomでクラウド録画をおこなう前にLTI-MCでインポートの設定をしておく必要があります．
{% endhint %}

### ❶ LTI-MCにアクセス

Zoomを使用したメールアドレスを使用しているアカウントでLMS（Moodle）にサインインし，LTI-MCにアクセスします．（[LTI-MCへのアクセス](../1-lti-mc/access.md) 参照）
